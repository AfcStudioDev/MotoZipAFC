...
namespace MotoParts.Infrastructure.Migrations
{
    ...
    [Migration("20260824060741_AddSupportTicketOptionalOrderAndSubject")]
    partial class AddSupportTicketOptionalOrderAndSubject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotoParts.Domain.Models.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MotoParts.Domain.Models.SupportMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MotoParts.Domain.Models.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MotoParts.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("MotoParts.Domain.Models.Purchase", "Purchase")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("MotoParts.Domain.Models.SupportMessage", b =>
                {
                    b.HasOne("MotoParts.Domain.Models.User", "AuthorUser")
                        .WithMany()
                        .HasForeignKey("AuthorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MotoParts.Domain.Models.SupportTicket", "Ticket")
                        .WithMany("Messages")
